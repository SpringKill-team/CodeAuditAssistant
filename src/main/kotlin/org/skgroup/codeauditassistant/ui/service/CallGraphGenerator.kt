...
import org.skgroup.codeauditassistant.analysis.graphs.callgraph.CallGraphBuilder
...
import org.skgroup.codeauditassistant.ui.component.ModuleSelectorDialog
...
object CallGraphGenerator {
    ...
    fun generate(
        ...
        CallGraphMemoryService.getInstance(project).clearCallGraph()
        CallGraphMemoryService.getInstance(project).clearMethodSigGraph()
        progressBar.apply {
            isVisible = true
