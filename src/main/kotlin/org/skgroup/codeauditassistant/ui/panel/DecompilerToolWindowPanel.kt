...
import org.skgroup.codeauditassistant.decompiler.Decompiler
...
class DecompilerToolWindowPanel(private val project: Project) {
    ...
    private val runButton = JButton(CAMessage.message("decompiler.run.button"))
    ...
    private fun initializeUI() {
        ...
        mainPanel.add(JBScrollPane(listPanel), BorderLayout.CENTER)
    ...
    private fun runDecompiler() {
        ...
        try {
            ...
            println(CAMessage.message("decompiler.execute.failed", e))
        }
    }
}
