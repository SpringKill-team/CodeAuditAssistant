...
class GoogleIOSSRF : BaseLocalInspectionTool() {
    ...
    companion object {
        private val MESSAGE = InspectionBundle.message("vuln.massage.GoogleIOSSRF")

        private val GOOGLEIO_METHOD_SINKS = mapOf(
            "com.google.common.io.Resources" to listOf(
    ...
    override fun buildVisitor(holder: ProblemsHolder, isOnTheFly: Boolean): PsiElementVisitor {
        return object : JavaElementVisitor() {
            override fun visitMethodCallExpression(expression: PsiMethodCallExpression) {
                if (SecExpressionUtils.isMethodSink(expression, GOOGLEIO_METHOD_SINKS)) {
